...
document.addEventListener("click", async function(e) {
  if(e.target.closest("#kino")){
  
        window.location.href = "../index.html";
      }
      });
      document.addEventListener("click", async function(e) {
        if(e.target.closest("#aktyor")){

     
        window.location.href = "../aktyor/aktyor.html";
      }
      });
      document.addEventListener("click", async function(e) {
      ...
      document.addEventListener("click", async function(e) {
        if(e.target.closest("#addmovies")){

        
        window.location.href = "../addMovie/addmovie.html";
        }
      });
      document.addEventListener("click", async function(e) {
    if (e.target.closest("#addactors")) {
      window.location.href = "../addActor/addactor.html";
    }
  });
  document.addEventListener("click", async function(e) {
    if (e.target.closest("#obhavo")) {
      window.location.href = "../obhavo/obhavo.html";
    }
  });
  document.addEventListener("click", async function(e) {
